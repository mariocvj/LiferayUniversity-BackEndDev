...
public class AssignmentPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_setAssignmentUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setAssignmentUtilPersistence(null);
	...
	private void _setAssignmentUtilPersistence(
		AssignmentPersistence assignmentPersistence) {

		try {
			Field field = AssignmentUtil.class.getDeclaredField("_persistence");

			field.setAccessible(true);

			field.set(null, assignmentPersistence);
		}
